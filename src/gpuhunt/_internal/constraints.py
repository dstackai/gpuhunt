...
KNOWN_NVIDIA_GPUS: list[NvidiaGPUInfo] = [
    ...
    NvidiaGPUInfo(name="RTX2060", memory=6, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2060", memory=12, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2060SUPER", memory=8, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2070", memory=8, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2070SUPER", memory=8, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2080", memory=8, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2080SUPER", memory=8, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX2080Ti", memory=11, compute_capability=(7, 5)),
    NvidiaGPUInfo(name="RTX3050", memory=6, compute_capability=(8, 6)),
    NvidiaGPUInfo(name="RTX3050", memory=8, compute_capability=(8, 6)),
    ...
    NvidiaGPUInfo(name="RTX3070", memory=8, compute_capability=(8, 6)),
    ...
    NvidiaGPUInfo(name="RTX3090Ti", memory=24, compute_capability=(8, 6)),
    NvidiaGPUInfo(name="RTX4060", memory=8, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4060Ti", memory=8, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4060Ti", memory=16, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4070", memory=12, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4070SUPER", memory=12, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4070Ti", memory=12, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4070TiSUPER", memory=16, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4080", memory=16, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4080SUPER", memory=16, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX4090", memory=24, compute_capability=(8, 9)),
    NvidiaGPUInfo(name="RTX5060", memory=8, compute_capability=(12, 0)),
    NvidiaGPUInfo(name="RTX5060Ti", memory=8, compute_capability=(12, 0)),
    NvidiaGPUInfo(name="RTX5060Ti", memory=16, compute_capability=(12, 0)),
    NvidiaGPUInfo(name="RTX5070", memory=12, compute_capability=(12, 0)),
    NvidiaGPUInfo(name="RTX5070Ti", memory=16, compute_capability=(12, 0)),
    NvidiaGPUInfo(name="RTX5080", memory=16, compute_capability=(12, 0)),
    ...
    NvidiaGPUInfo(name="RTXPRO4500", memory=32, compute_capability=(12, 0)),
